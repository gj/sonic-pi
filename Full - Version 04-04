...
in_thread do
  ...
  with_fx :compressor, clamp_time: 0, relax_time: 0 do
    with_fx :reverb, mix: 0.2, damp: 1, room: 0.5 do
      320.times do drum(:drum_cymbal_closed, 1) end   # Measures 31-110
      96.times do drum(:drum_cymbal_open, 1) end      # Measures 111-134
      sleep 4                                         # Measure  135
      160.times do drum(:drum_cymbal_open, 1) end     # Measures 136-175
...
in_thread do
  sleep 120                                           # Measures 1-30
  with_fx :compressor, amp: 1.5, slope_above: 0, clamp_time: 0, relax_time: 0 do
